...
val make_bler_nodes : unit -> unit (* consults Params.nodes *)
val set_tracefile : string -> unit
val cleanup : unit -> unit

(* Actions *)
val move_nodes : f:(node:Node.node_t -> unit) -> percent:float -> unit
...
val do_one_route : src:Common.nodeid_t -> dst:Common.nodeid_t ->
  Coord.coordf_t Route.t
val gui_one_route : unit -> unit
